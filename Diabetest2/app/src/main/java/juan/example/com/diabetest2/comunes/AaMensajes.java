...
public class AaMensajes extends ArrayAdapter {
    ...
    //Constructor
    public AaMensajes(Activity actividadTraida, String[] fechasTraidas, String[] remitentesTraidos, String[] mensajesTraidos) {
        super(actividadTraida, R.layout.plantilla_mensajes, fechasTraidas);
    ...
    public View getView(int laPosicion, View nuevaVista, ViewGroup parent) {
        ...
        nuevaVista = inflado.inflate(R.layout.plantilla_mensajes, null, true);
