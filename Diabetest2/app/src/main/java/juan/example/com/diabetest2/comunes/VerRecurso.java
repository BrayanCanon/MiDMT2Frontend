...
public class VerRecurso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Abrir video
        TextView ad = (TextView) findViewById(R.id.id_link_YouTube);
...
//Borrar el recurso
    public void borrar (View view){
        VerRecurso.borrarDB bo = new VerRecurso.borrarDB();
        bo.execute();
    }
    String respuesta;
    ...
    public void modificar (View view){
        Intent intento = new Intent(this, ModificarRecurso.class);
