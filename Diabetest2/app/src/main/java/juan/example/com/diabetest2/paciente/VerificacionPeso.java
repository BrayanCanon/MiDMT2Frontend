...
public class VerificacionPeso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificacion_peso);
    ...
    public void ingresar_verificacion_rutina(View v){
        ...
        if(valor.length()>1) {
            Guardar guardarValorVerificacion = new Guardar();
    ...
    private class Guardar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                    SoapObject solicitud = new SoapObject(Inicio.namespace, "crearVerificacionPaciente");
                    solicitud.addProperty("codPaciente", ""+id);
                    solicitud.addProperty("idRutina" , 1);
                    ...
                    transporte.call("http://Servicios/crearVerificacionPaciente", sobre);
